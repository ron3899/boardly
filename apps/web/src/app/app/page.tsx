        ...
        {isLoading ? (
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              <button
                onClick={() => setCreateOpen(true)}
                className="group relative rounded-lg border-2 border-dashed border-border bg-card hover:border-monday-purple hover:bg-monday-purple/5 transition-all p-8 flex flex-col items-center justify-center min-h-[140px]"
              >
                ...
                <span className="text-sm font-medium text-muted-foreground group-hover:text-monday-purple transition-colors">
                  New Board
                </span>
              </button>
            </div>
